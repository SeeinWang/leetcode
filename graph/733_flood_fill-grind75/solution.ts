 ...
 *     (pixels that share a side with the original pixel, either top, bottom,
 *     left, or right) and shares the same color as the starting pixel.
...
// Approach: DFS/BFS from (sr,sc), recolor cells matching original color. Time: O(m*n), Space: O(m*n)
