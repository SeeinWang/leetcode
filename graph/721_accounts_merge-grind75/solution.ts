 ...
 *   as none of their email addresses are used by other accounts. We could
 *   return these lists in any order.
 *
 * Example 2:
 *   Input: accounts = [
...
// Approach: Union-Find on emails within each account; group by root, sort. Time: O(NK·α), Space: O(NK)
